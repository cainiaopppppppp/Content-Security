...
class Detection:
    def __init__(self):
        ...
        caffemodel = os.path.join(dirname, '..', '..', 'model', 'model2', 'detection_model', 'Widerface-RetinaFace.caffemodel')
        deploy = os.path.join(dirname, '..', '..', 'model', 'model2', 'detection_model', 'deploy.prototxt')
